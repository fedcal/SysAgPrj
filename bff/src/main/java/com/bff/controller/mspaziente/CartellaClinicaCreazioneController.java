...
import com.bff.service.mspaziente.OperazioniSpecificheService;
...
@RestController
@RequestMapping(WebConstants.REST_CONTEX_BFF + WebConstants.REST_CONTEX_PAZIENTI + "/malattia")
@Tag(name = "Microservizio paziente", description = "ms-paziente")
